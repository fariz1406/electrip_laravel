...

{
    ...
    {
        // Menggunakan middleware untuk membatasi akses berdasarkan peran
        $this->middleware(['auth', 'role:Pengguna|Admin'])->only([
            'checkProfil', 'tambah', 'submit', 'edit', 'update', 'delete'
        ]);
    }
