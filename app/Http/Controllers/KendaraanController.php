...
class KendaraanController extends Controller
{
    ...
    {
        $this->middleware('permission:kendaraan-list|kendaraan-create|kendaraan-edit|kendaraan-delete', ['only' => ['tampil']]);
        $this->middleware('permission:kendaraan-create', ['only' => ['tambah', 'submit']]);
        $this->middleware('permission:kendaraan-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:kendaraan-delete', ['only' => ['delete']]);
    }
