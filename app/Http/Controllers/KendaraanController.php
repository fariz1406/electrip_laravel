...
class KendaraanController extends Controller
{
    ...
    public function __construct() {
        $this->middleware('permission:kendaraan-manage', ['only' => ['tambah','submit','edit','update','delete ']]);
        $this->middleware('permission:kendaraan-show',['only' => ['tampil','pilihan', 'pilihanMotor']]);
    }
