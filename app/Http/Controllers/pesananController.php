...
class pesananController extends Controller
{
    ...
    $this->middleware('permission:pesanan-pengguna',['only'=>['checkout','submit','belumDibayar','diProses','diKirim','diPakai']]);
    $this->middleware('permission:pesanan-admin',['only'=>['tampil']]);
    }
