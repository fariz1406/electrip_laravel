...
// checklist konversi controller pake spatie (role | permission)
// AuthController done
// KendaraanController done
// VerifikasiUser done
// PesananController 
// ProfilController done
// ValidasiVerif 
...
Route::middleware(['auth', 'role:Admin|Admin Finance'])->group(function () {
    //admin
